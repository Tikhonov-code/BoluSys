...
function ChartCreate(chartSelector,df, dt, bid,chart_type) {
    ...
    //------------------------------------------------------------------------------------
    var ds = "BolusChart_new.aspx?DateFrom=" + df + "&DateTO=" + dt + "&Bolus_id=" + bid + "&SP=GetDataForChart&chart_type=" + chart_type;
...
function GetCowsLogs(aid_par) {
    //-------------------------------------------
    var url = 'BolusChart_new.aspx?SP=GetCowsLogs&Animal_id=' + aid_par;
    var Param = {};
...
function IntakesChart_Show0(df, dt, bid) {
    ...
    var ds = "BolusChart_new.aspx/GetIntakesData?DateFrom=" + df + "&DateTo=" + dt + "&Bolus_id=" + bid + "&SP=GetIntakesData";
...
function GetTotalIntakes(dt1, dt2, bid) {
    ...
    //-------------------------------------------
    var url = "BolusChart_new.aspx/GetTotalIntakes";
    var Param = {};
...
function GetAverTemperature(dt1, dt2, bid) {
    ...
    //-------------------------------------------
    var url = "BolusChart_new.aspx/GetAverageTemperature";
    var Param = {};
